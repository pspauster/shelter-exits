...
def rename_file(formatted_date):
    ...
    original_file = "temporary_housing_reports/temp_temporary_housing_report.pdf"

    # Define the new file name with the formatted date
    new_file = f"temporary_housing_reports/temporary_housing_report_{formatted_date}.pdf"
...
if os.path.exists(f"temporary_housing_reports/temporary_housing_report_{formatted_date}.pdf"):
