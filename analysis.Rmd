...
#percent of DHS shelter population that exited each month, on average June to December

5004.0000/(45813.1667+5004.0000)

#percent of DHS shelter population that exited each month to permanent housing, on average June to December

1248.8333/(45813.1667+5004.0000)

#percent of exits with vouchers, DHS total, June to December
exits %>% filter(housing_category == "Permanent Housing", agency == "DHS") %>% group_by(category) %>% summarize(total = sum(exits, na.rm = T)) %>% 
